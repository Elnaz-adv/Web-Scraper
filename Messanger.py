...
COLOUR_LIGHT_BACKGROUND_4 = "#ffbaba"
...
class Messenger(tk.Tk):
    '''
    Defines the generall configuration and styles.
    '''
    ...
    def style_container(self):
        ...
        style.configure(
            "RecieveButton.TButton", background=COLOUR_LIGHT_BACKGROUND_1, borderwidth=0
        )
        style.configure(
            "QuitButton.TButton", background=COLOUR_LIGHT_BACKGROUND_4, borderwidth=0
        )
